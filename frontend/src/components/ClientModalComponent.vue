<script lang="ts" src="../services/ts/ClientModalComponent.ts"></script>

<template>
  <div class="modal" id="compteModal">
    <div class="card">
      <header>
        <h3 v-if="!customer">Créer un nouveau compte</h3>
        <h3 v-if="customer">Modifier un compte</h3>
