<script lang="ts" src="../services/ts/UpdateMoneyModal.ts"></script>
<template>
  <div class="modal" id="updateMoney">
    <div class="card">
      <header>
      ...
      <div class="form flex">
        ...
        <div class="submit-button">
          <button class="primary-button" id="update-money" @click="updateMoney(customer.id)">Modifier</button>
        </div>
      </div>
    </div>
  </div>
