    ...
    <div class="card">
      ...
      <form>
        <div>
          ...
          <input name="nom-user" class="input-field" type="text" :value=" user ? user.name : ''" placeholder="nom de l'utilisateur" id="nom-user"
                 required>
        </div>
        <div>
          <label class="input-label" for="prenom-user">Prénom</label>
          <input name="prenom-user" class="input-field" type="text" :value="user ? user.firstname : ''" placeholder="prénom de l'utilisateur"
                 id="prenom-user" required>
        </div>
        <div>
          <label class="input-label" for="email-user">Email</label>
          <input name="email-user" class="input-field" type="text" :value="user ? user.email : ''" placeholder="...@gmail.com"
                 id="email-user" required>
        </div>
        <div>
