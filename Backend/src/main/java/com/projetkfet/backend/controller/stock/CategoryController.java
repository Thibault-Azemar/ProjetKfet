...
public class CategoryController {
    ...
    @GetMapping(path = "/all")
    public @ResponseBody List<CategoryProjection> getAllCategories() throws Exception {
    ...
    public @ResponseBody UUID addNewCategory(@RequestParam("name") String name,
            @RequestBody(required = false) ImageDTO image) throws Exception {
    ...
    @PatchMapping()
    public @ResponseBody String updateCategory(@RequestParam("id") String id,
    ...
    @DeleteMapping()
    public @ResponseBody String deleteCategory(@RequestParam("id") String id) throws Exception {
